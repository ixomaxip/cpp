...
public:
    ...
    {
        m_birth = birth;
        f_names[m_birth] = first_name;
        l_names[m_birth] = last_name;
    }
    ...
    string GetFullName(int year) const
    {
        ...
        return get_full_name(first_name, last_name, year);
    }
...
private:
    ...
    string find_name(const map<int, string>& names, int year) const
    {
        string name;
    ...
    vector<string> get_history(const map<int, string>& names, int year) const
    {
        vector<string> hist;
        auto last_change = names.upper_bound(year);
    ...
    string get_full_name(string first_name, string last_name, int year) const
    {
        if (year < m_birth)
            return "No person";
    ...
    string joined_history(vector<string> names) const
    {
        if (names.empty())
        {
            return "";
